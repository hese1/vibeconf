---
description: Code implementation agent that writes and edits code. Delegates to the reviewer subagent for linting, formatting, and test validation after making changes.
mode: primary
temperature: 0.1
permission:
  edit: allow
